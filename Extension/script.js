...
$(document).ready(function() {
    ...
    $.get(query, function(data, status) {
        ...
        if(data.response=="1")
        {
            ...
            function alertMX(t) {
            $( "body" ).append( $( "<div id='boxMX'><p class='msgMX' align=\"center\" style=\"font-family:Amatic;color:black;font-size:20px\"><img src='https://i.pinimg.com/originals/7b/dd/1b/7bdd1bc7db7fd48025d4e39a0e2f0fd8.jpg' alt='hello' height=30px width=30px><br>Safe To Use, Legitimate Website</p></div>" ) );
            //$('.msgMX').text(t); 
